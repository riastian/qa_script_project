...
class AutoTest:
    ...
    def export_dxf_automation(object):
        ...
        for filename in inputfilelist:
            ...
            pta.export_dxf(filename, outputfolder)
            ## second option
            pta.init_export_dxf_option()
 ...
 # high quality rendering 테스트 자동화 함수
    ...
    def colorway_mode_automation(object):
        ptaac = PythonTestAPIAddColorway()
        ptaac.add_colorway_test()
        return
...
####
## Class Name: PythonTestAPIAddColorway
## Purpose: Open Python APIs for Change Colorway Test Automation
##
class PythonTestAPIAddColorway:       
    __mdm_func = MarvelousDesignerModule()
